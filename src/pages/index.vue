			...
			<section class="mb-16">
				<v-row justify-start>
					<v-col v-for="item in itens" :key="item" cols="3">
						<v-card elevation="4" color="blue-grey-lighten-5" height="175" class="mt-5">
							<v-card-text>
								<v-row>
									<v-col>
  ...
  name: "IndexPage",
	...
	data() {
		return {
			itens: [
				{
					img: '/gato burmilla.jpg',
					nome: 'Banho',
					desc: 'Banho para o seu pet.',
				},
				{
					img: '/caoEndiabrado.jpg',
					nome: 'Vacinação',
					desc: 'Vacina contra a raiva.',
				},
			]
		}
	}
